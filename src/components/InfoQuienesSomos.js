  ...
  return (
    <div className="qsWrap">
      <section className="container qs">
        ...
        <p className="qsLead">
          Somos una empresa de comunicación gráfica especializada en la impresión
          de libros, catálogos, revistas y folletos. Desde 1998 atendemos a
          empresas, instituciones y particulares en todo el país.
        </p>
        <ul className="qsKpis" aria-label="Indicadores">
          <li><strong>Desde 1998</strong><span>trayectoria</span></li>
          <li><strong>+1000 m²</strong><span>instalaciones</span></li>
          <li><strong>25</strong><span>profesionales</span></li>
        </ul>

        {/* Bloque 1 */}
        <div className="qsGrid">
          <figure className="qsMedia">
            <img src={foto} alt="Equipo y procesos en Edicosa" className="qsImg" />
          ...
          <div className="qsCopy">
            ...
            <p>
              ...
              No aplicamos cargos extra por control de archivos ni asesoramiento.
            </p>
        ...
        <div className="qsGrid qsGrid--reverse">
          <div className="qsCopy">
            ...
            <p>
              Operamos desde Catamarca para toda Argentina. Más de 1.000 m² entre
              talleres, oficinas y áreas de reunión.
            </p>
            <p>
            ...
            <p>
              Offset KBA de 5 cuerpos con lacado en línea para tiradas largas con
          ...
          <figure className="qsMedia">
            <img src={fotoMaquina} alt="Maquinaria de impresión Edicosa" className="qsImg" />
        ...
        <div className="qsCallout">
          <p>
            ...
            desplegables, flyers, carpetas y más, podemos darte el mejor servicio.
          </p>
        </div>
      </section>
